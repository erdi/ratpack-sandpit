...
public class Book extends TableImpl<BookRecord> {
	...
	/**
	 * The reference instance of <code>lab08.book</code>
	 */
	...
	/**
	 * The column <code>lab08.book.isbn</code>.
	 */
	...
	/**
	 * Create a <code>lab08.book</code> table reference
	 */
	public Book() {
		this("book", null);
	}
	...
	/**
	 * Create an aliased <code>lab08.book</code> table reference
	 */
	...
	private Book(String alias, Table<BookRecord> aliased, Field<?>[] parameters) {
		super(alias, Lab08.Lab08, aliased, parameters, "");
	}
